/* slidy.js for UMBC CS201

   Adapted from slidy.js from W3C which is:
...
// find home url from meta element
...
//    start.innerHTML = "print!".localize();
      ...
      var home_url = findHomeURL();
      if (home_url)
      {
         var home = document.createElement("a");
         home.setAttribute("href", home_url);
         home.setAttribute("title", "home".localize());
         home.innerHTML = "home?".localize();
